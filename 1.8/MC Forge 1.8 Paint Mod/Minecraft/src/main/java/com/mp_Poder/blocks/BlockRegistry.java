...
public class BlockRegistry {
	...
	public static Block VioletStone;
	...
	public static void initializeBlock(){
		...
		MagentaStone = new ModBlock(Material.rock).setUnlocalizedName("MagentaStone");
		VioletStone = new ModBlock(Material.rock).setUnlocalizedName("VioletStone");
		PurpleStone = new ModBlock(Material.rock).setUnlocalizedName("PurpleStone");
		...
		StoneStates = new IBlockState[]{
				...
				MagentaStone.getDefaultState(),
				VioletStone.getDefaultState(),
				PurpleStone.getDefaultState()
		};
	}
	...
	public static void register(){
		...
		GameRegistry.registerBlock(MagentaStone, MagentaStone.getUnlocalizedName().substring(5));
		GameRegistry.registerBlock(VioletStone, VioletStone.getUnlocalizedName().substring(5));
		GameRegistry.registerBlock(PurpleStone, PurpleStone.getUnlocalizedName().substring(5));
	}
	...
	public static void registerRenders()
	{
		...
		registerRender(MagentaStone);
		registerRender(VioletStone);
		registerRender(PurpleStone);
	}
