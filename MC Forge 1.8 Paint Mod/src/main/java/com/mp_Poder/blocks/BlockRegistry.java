...
public class BlockRegistry {
	...
	public static void initializeBlock(){
		...
		RedStone = new ModBlock(Material.rock).setUnlocalizedName("RedStoneBlock");
	...
	public static void register(){
		...
		GameRegistry.registerBlock(RedStone, RedStone.getUnlocalizedName().substring(5));
